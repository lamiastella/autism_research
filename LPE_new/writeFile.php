...
$base_dir = "ftp://langcomplab.net/10_28_2013/LPE_new";
...
ftp_site($ftpstream,"CHMOD 0777 /public_html/bin498/resultsLPE.csv");

//Write to file
$fp = fopen('/home/langcomp/public_html/bin498/resultsLPE.csv', 'a');
fputs($fp,$data);
fclose($fp);

//Make the file writable only to owner
ftp_site($ftpstream,"CHMOD 0644 /public_html/bin498/resultsLPE.csv");
